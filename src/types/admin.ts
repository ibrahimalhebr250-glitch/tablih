export type AdminSection = 'dashboard' | 'analytics' | 'inventory' | 'market' | 'orders' | 'deals' | 'finance' | 'commissions' | 'users' | 'ratings' | 'comments' | 'buyer_inventory' | 'whatsapp' | 'support' | 'settings';
