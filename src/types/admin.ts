export type AdminSection = 'dashboard' | 'analytics' | 'inventory' | 'market' | 'orders' | 'deals' | 'finance' | 'users' | 'ratings' | 'comments' | 'buyer_inventory' | 'order_matching' | 'whatsapp' | 'settings';
