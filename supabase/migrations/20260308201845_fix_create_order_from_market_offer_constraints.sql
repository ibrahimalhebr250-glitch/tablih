/*
  # Fix create_order_from_market_offer constraints

  1. Changes
    - Update `current_stage` to use valid value 'matching' instead of 'submitted'
    - Update `request_type` to use valid value 'standard' instead of 'market_negotiation'
    - The `order_source` column (which has no constraint) keeps 'market_offer' for tracking
*/
