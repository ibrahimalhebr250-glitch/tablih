/*
  # Fix create_deal_from_market_negotiation to use correct column name

  The inventory_batches table uses 'phone' not 'supplier_phone'
*/
...
BEGIN
  ...
  -- Create deal (using v_batch.phone as supplier_phone)
  INSERT INTO deals (
    deal_ref,
    inventory_batch_id,
    buyer_phone,
