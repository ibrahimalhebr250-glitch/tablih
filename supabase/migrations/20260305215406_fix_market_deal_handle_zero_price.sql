/*
  # Fix Market Deal - Handle Zero Price
  
  1. Changes
    - If price_per_pallet is 0 or NULL, use 1 SAR as minimum
    - This ensures the deal can be created while respecting the constraint
*/
